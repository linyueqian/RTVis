...
def update_figure(relayoutData, top_n_bar, click_data, top_n_node, top_n_words, bar_fig, is_open, n1, n2):
    x_range = None
    ...
    return node_fig, river_fig, race_fig, bar_fig, click_data, url, is_open
